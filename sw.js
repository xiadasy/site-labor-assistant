...
self.addEventListener('fetch',e=>{
 ...
 const netFirst=['/index.html','/project.html','/chengde.html','/search.html','/project-encrypted-data.json','/chengde-project-data.json','/search-lite.json','/search-index.json','/search-meta.json','/project-widget-summary.json','/project-widget.js'];
