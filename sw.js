const CACHE='labor-v29';
const ASSETS=['./','./index.html','./project.html','./company.html','./encrypted-data.json','./project-encrypted-data.json','./company-encrypted-data.json','./widget-summary.json'];
